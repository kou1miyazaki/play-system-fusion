...
public class SystemFusionErrorHandler extends DefaultHttpErrorHandler {

  @Inject
  public SystemFusionErrorHandler(Configuration configuration, Environment environment,
