 ...
 *
 */
public class RoleConstraint extends CommonConstraint {

	/** 名前. */
	public static final String C_NAME = "Role";
	/** 名前:詳細. */
	...
	/** テーブル名. */
	public static final String C_TABLE = "CMN_TM_ROLE";
	/** シーケンス名. */
	...
	/** カラム:ロール説明. */
	public static final String C_TABLE_COL_ROLE_DESC = "ROLE_DESC";

	/** アイテム:ID. */
	public static final List<String> C_ITEM_DETAIL =
			(List<String>) Arrays.asList("id", "name", "roledesc");
	/** アイテム:ラベル. */
	public static final List<String> C_ITEM_LABEL =
			(List<String>) Arrays.asList("ID", "ロール名", "ロール説明");
	/** アイテム:タイプ. */
	public static final List<String> C_ITEM_TYPE =
			(List<String>) Arrays.asList("text", "text", "text");
	/** アイテム:表示. */
	public static final List<String> C_ITEM_DISPLAY =
			(List<String>) Arrays.asList("col1", "col2", "col1");

	/** URL. */
	public static final String C_URL_BASE = "/adm/role";
	/** URL:インデックス. */
	...
	/** ラベル. */
	public static final String C_LABEL_NAME = "ロール";
	/** ラベル:一覧. */
